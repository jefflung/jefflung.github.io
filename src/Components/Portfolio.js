...
const captions = [
  <p>
    <b>Situation & Task </b>: A Manchester accommodation agency sent me a recruitment task on February 2021.<br />
  ...
  <b>Action</b>: Design some pages of the website and built it with Bootstrap and CSS.<br />
  ...
  <b>Action</b>: To ensure coverage for all public, the website is built by following the WCAG 2.0 Level AA standard.<br />
  <b>Result</b>: The government department passed the website usability standard for the public.
  </p>,
  <p>
...
<p>
  <b>Situation & Task </b>: An accommodation agency who served the customers in south east asia request for a website.<br />
  ...
  <b>Result</b>: A responsive website provided a platform for visitors to book accommodation and transport in the agency location.
</p>,
<p>
  <b>Situation & Task </b>: Refresh a website for a long history Hong Kong football club.<br />
  <b>Action</b>: After a design tone has been confirmed, I design some pages and built them with Bootstrap and CSS.<br />
  <b>Result</b>: The old website has been upgraded to be compatible with different digital widgets and a refresh outlook for visitors. 
</p>,
<p>
...
<p>
  ...
  <b>Action</b>: A feminine aesthetic design included color tone and graphics is applied for the web design.<br />
  <b>Result</b>: The client is satisfied with the layout design which can fit their company image.
</p>,
<p>
  <b>Situation & Task </b>: A gaming platform company required a front page layout for updating the existing one.<br />
  <b>Action</b>: I provided several design which conveyed some styles related to luxury services.<br />
...
<p>
  <b>Situation & Task </b>: The Charity group Plan needed design of scarf as a souvenir for an event.<br />
  <b>Action</b>: I used the colors from the Plan logo for the design and a concise design was applied to convey a comfy style.<br />
  <b>Result</b>: It was my pleasure that Plan could use my design for the charitable purpose.
</p>,
<p>
  <b>Situation & Task </b>: An app for hiring taxi was before the prototype stage.<br />
  <b>Action</b>: I created the flowchart of the app with given assets from my teammates to illustrate the steps throughout the hiring process.<br />
  <b>Result</b>: All colleagues could have a clear vision for the hiring flow in the app, and this facilitated the further improvement.
</p>,
<p>
  <b>Situation & Task </b>: A gaming platform app was in a development stage and a wireframe was needed.<br />
  <b>Action</b>: It was drawn based on the sketch provided by UX designer. I adjusted all elements to be unified like size and style for buttons and text.<br />
  <b>Result</b>: The wireframe provided a map for developers to take action for development of the app.
</p>,
<p>
  <b>Situation & Task </b>: A video was used to express the values of the medical corporate company for motivation of staffs.<br />
  <b>Action</b>: The 3d assets was created with Maya then the assets was editing with Aftereffect to export the video.<br />
...
<p>
  ...
  <b>Action</b>: It was an Android game demo. Concepts was built up with researches and references with movie. It was developed with Maya, Unity, Javascript.<br />
...
<p>
  ...
  <b>Action</b>: The 3d was built and rendered with Maya and Mentalray. I took references from the movie Transformers and the render was aimed for a realistic standard.<br />
          ...
          <div className="twelve columns collapsed">
            ...
            <div className="columns portfolio-item">
              ...
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <img src={image1Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:0 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <img src={image2Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:1 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                  <img src={image3Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:2 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image4Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:3 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image5Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:4 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image6Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:5 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image7Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:6 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image8Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:7 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image9Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:8 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image10Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:9 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image11Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:10 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image12Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:11 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image13Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:12 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image14Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:13 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image15Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:14 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image16Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:15 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image17Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:16 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image18Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:17 })} ></div>
                </div>
              </div>
              <div className="columns portfolio-item">
                <div className="item-wrap">
                <img src={image19Thumb}/>
                  <div className="overlay" onClick={() => this.setState({ isOpen: true, index:18 })} ></div>
                </div>
              </div>
